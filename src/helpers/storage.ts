...
export const travelUploadOption = {
    // Enable file size limits
    limits: {
        fileSize: 20 * 1024 * 1000
    },
    ...
    storage: diskStorage({
        ...
        destination: (req: any, file: any, cb: any) => {
            ...
            const uploadPath = multerConfig.dest + '/travels'
            // Create folder if doesn't exist
            if (!existsSync(uploadPath)) {
                mkdirSync(uploadPath)
            }
...
export const agentUploadOption = {
    // Enable file size limits
    limits: {
        fileSize: 20 * 1024 * 1000
    },
    ...
    storage: diskStorage({
        ...
        destination: (req: any, file: any, cb: any) => {
            ...
            const uploadPath = `${multerConfig.dest}/${file.fieldname}`
            // Create folder if doesn't exist
            if (!existsSync(uploadPath)) {
                mkdirSync(uploadPath)
            }
...
export const requestMemberUploadOption = {
    // Enable file size limits
    limits: {
        fileSize: 20 * 1024 * 1000
    },
    ...
    storage: diskStorage({
        ...
        destination: (req: any, file: any, cb: any) => {
            ...
            const uploadPath = multerConfig.dest + '/surat-kerjasama'
            // Create folder if doesn't exist
            if (!existsSync(uploadPath)) {
                mkdirSync(uploadPath)
            }
...
export const userDetailUploadOption = {
    // Enable file size limits
    limits: {
        fileSize: 20 * 1024 * 10000
    },
    // Check the mimetypes to allow for upload
    fileFilter: (req: any, file: any, cb: any) => {
        if (file.mimetype.match(/\/(jpg|jpeg|png)$/)) {
